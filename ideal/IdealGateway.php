...
namespace OwnPay\Modules\Gateways\Ideal;
...
/**
 * iDEAL Payment Gateway Adapter.
 * 
 * Implements strict type system, PCI-DSS compliance signature checking,
 * and secure backchannel payment status verification.
 */
final class IdealGateway implements PluginInterface, GatewayAdapterInterface
{
    use GatewayDefaults;
    ...
    public function slug(): string { return 'ideal'; }
    public function name(): string { return 'iDEAL'; }
    public function version(): string { return '1.0.0'; }
    public function description(): string { return 'iDEAL checkout gateway'; }
